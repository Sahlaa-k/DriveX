...
class CanceldPage extends StatefulWidget {
  const CanceldPage({super.key});

  @override
  State<CanceldPage> createState() => _CanceledPageState();
}
//https://in.pinterest.com/pin/454582156165299971/
class _CanceledPageState extends State<CanceldPage> {
  final List<Map<String, dynamic>> canceled = [
    {
      "type": "Driver",
